        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="about" className="space-y-4 mt-4">
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-foreground mb-2">About UZ-log</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  UZ-log is a personal content vault with multi-device sync, user authentication, and public sharing capabilities.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>✓ Store 9 content types (text, code, image, video, file, link, prompt, script, book)</li>
          ...
          <TabsContent value="contact" className="space-y-4 mt-4">
            <div className="space-y-3">
              <p className="text-sm text-muted-foreground">
                Have feedback, questions, or found a bug? We'd love to hear from you!
              </p>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">dupsobon@gmail.com</p>
                </div>
              </a>
